...
This WC sets the ground for inference and deduction before we formally explore logical inference.

# Background and Requirements

To attempt and submit the task you will need
- to understand statements in English
- to be able to infer information from provided clues
